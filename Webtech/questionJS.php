...
<?php
    ...
    */
    $query = "SELECT * FROM `js_questions`
                WHERE js_question_number = $number";
    ...
    <section class="site-section">
        <div class="container">
            <div class="media d-block feature">
                ...
                <div class="current"><p>Question <?php echo $question['js_question_number']?> of <?php echo $total; ?></p></div>
                <p>
                    <?php echo $question['text']; ?>
                </p>
                <form method="post" action="processJS.php">
