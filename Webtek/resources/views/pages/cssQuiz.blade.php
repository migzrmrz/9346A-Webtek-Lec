          ...
          <div class="row align-items-center site-hero-inner justify-content-center">
            <div class="col-md-8 text-center">
              ...
              <div class="mb-5 element-animate">
                <h1>CSS Quiz</h1>
                <p class="lead">Test your CSS Knowledge</p>
                <p>This is a multiple choice quiz to test your knowledge of CSS</p>
                <p><strong>Number of questions: </strong> 5</p>
                <p><strong>Type: </strong>Multiple Choice</p>
                <p><strong>Estimated Time: </strong>4 Minutes</p>
                <p><a href="{{ route('cssQuestions')}}" class="btn btn-primary">Start Quiz</a></p>
              </div>
            </div>
          </div>
        </div>
